...
setup(name="psycopg2",
      ...
      keywords=['postgresql', 'database', 'adapter', 'dbapi', 'postgres', 'psycopg', 'sql'],
      project_urls={
          'Documentation': 'http://initd.org/psycopg/docs/',
          'Bug Tracker': 'http://psycopg.lighthouseapp.com/',
          'Source Code': 'https://github.com/wsx7524999/psycopg2',
      },
